...
import { OverviewTab, ProfileHeader, RepositoriesTab, WalkthroughsTab } from '@/components/profile';
...
export default function ProfilePage({ params }: { params: Promise<{ username: string }> }) {
  ...
  return (
    <DashboardLayout>
      <div className="min-h-full w-full overflow-auto bg-gray-50">
        <ProfileHeader
          profile={profile}
          stats={stats}
          activeTab={activeTab}
        ...
        <div className="px-8 py-6">
          ...
          {activeTab === 'walkthroughs' && (
            <WalkthroughsTab allWalkthroughs={walkthroughs} isLoading={walkthroughsLoading} />
          )}
