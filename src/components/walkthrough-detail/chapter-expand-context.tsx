...
const ChapterExpandContext = createContext<ChapterExpandContextValue | null>(
  null,
);

export function ChapterExpandProvider({
  children,
}: {
  ...
  const register = useCallback(
    (chapterId: string, expandFn: () => void) => {
  ...
  const expandAndScrollToFile = useCallback(
